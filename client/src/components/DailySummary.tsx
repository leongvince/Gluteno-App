        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            <div className="bg-gray-50 dark:bg-gray-700 rounded p-2">
              ...
              <p className="text-xs mt-1 text-gray-700 dark:text-gray-300 font-medium">Mood</p>
              <p className="text-sm font-medium capitalize text-gray-800 dark:text-white">{summaryData?.mood || 'Okay'}</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 rounded p-2">
              ...
              <p className="text-xs mt-1 text-gray-700 dark:text-gray-300 font-medium">Meals</p>
              <p className="text-sm font-medium text-gray-800 dark:text-white">{summaryData?.mealCount || 0}/{summaryData?.totalMeals || 3} GF</p>
            </div>
            <div className="bg-gray-50 dark:bg-gray-700 rounded p-2">
              ...
              <p className="text-xs mt-1 text-gray-700 dark:text-gray-300 font-medium">Symptoms</p>
              <p className="text-sm font-medium capitalize text-gray-800 dark:text-white">{summaryData?.symptomLevel || 'None'}</p>
            </div>
          </div>
        )}
      </div>
